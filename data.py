...
postgres_user = Variable.get("WEBSHOP_POSTGRES_USER", default_var=os.environ.get("WEBSHOP_POSTGRES_USER"))
postgres_password = Variable.get("WEBSHOP_POSTGRES_PASSWORD", default_var=os.environ.get("WEBSHOP_POSTGRES_PASSWORD"))
# Define dbt commands
dbt_seed_commands = [
